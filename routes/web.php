...
Route::get('/clothing', 'ProductController@index2')->name('product.index2');
Route::get('/accesories', 'ProductController@index3')->name('product.index3');
Route::get('/product/filter', 'ProductController@filter')->name('product.filter');
Route::get('/product/filter2', 'ProductController@filter2')->name('product.filter2');
Route::get('/product/filter3', 'ProductController@filter3')->name('product.filter3');
