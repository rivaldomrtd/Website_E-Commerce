    ...
    <div class="container p-0 show">
        <div class="row sixtyvh">
            ...
            <div class="col-lg-4 col-sm-12 pl-5 pr-5">
                <h6><strong>{{ $product2->brand }}</strong></h6>
                <h5>{{ $product2->name }}</h5>
                <div class="card">
                    <div class="card-body">
                        <div class="show-info">
                            ...
                            <div class="info-3">
                                <p>This product is pre-verified, and will be ready to ship instantly. Expedited shipping
                                    options will be available in checkout.
                                </p>
                            </div>
                            <a href="{{ route('cart.add', ['product' => $product2->id]) }}" id="add-to-cart"
