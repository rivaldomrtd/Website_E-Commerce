                        ...
                        @foreach ($products as $product)
                            <div class="col-12 d-flex p-2 justify-content-between cart-item">
                                ...
                                <div class="item-detail mr-auto d-flex flex-column justify-content-center">
                                    ...
                                    <div class="info-5">
                                        <a href="{{ route('cart.remove', ['id' => key($products)]) }}"
                                            class="remove-cart">
                        ...
                        <div class="card-body">
                            <div class="cart-checkout">
                                ...
                                <div class="info-3 pt-3">
                                    <a href="{{ route('checkout.index') }}"><button
                                            class="button-primary w-100">CHECKOUT</button></a>
                                </div>
                                <div class="info-4 pt-3">
                                    <a href="{{ route('product.index') }}"><button class="button w-100">CONTINUE
                                            SHOPPING</button></a>
                                </div>
                            </div>
                        </div>
