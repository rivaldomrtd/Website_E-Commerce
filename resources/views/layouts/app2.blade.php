                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @if (Auth::user()->role == 'Customer')
                                        <a href="{{ route('order.show', ['user' => Auth::user()->id]) }}"
                                            class="dropdown-item">Purchase History</a>
                                    @endif
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Rivaldo Marta Dinata<br> Surabaya <br> +62 8956-0588-2133 <br> rivaldomartadinata@gmail.com
                        </p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Follow Us On</h3>
                        <ul>
                            <li><a href='https://www.instagram.com/rivaldo.martd/' target='_blank'>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Designed from laravel by Rivaldo Marta Dinata</p>
                        <p>EAS_PTW &copy; 2021. All Rights Reserved</p>
                    </div>
